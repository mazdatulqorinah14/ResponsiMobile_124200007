class DetailMatchesModel {
  ...
  DetailMatchesModel.fromJson(Map<String, dynamic> json)
      : id = json['id'] as String?,
        ...
        homeTeam = (json['homeTeam'] as Map<String, dynamic>?) != null
            ? HomeTeamDetail.fromJson(json['homeTeam'] as Map<String, dynamic>)
            : null,
        awayTeam = (json['awayTeam'] as Map<String, dynamic>?) != null
            ? AwayTeamDetail.fromJson(json['awayTeam'] as Map<String, dynamic>)
            : null,
        officials = (json['officials'] as List?)
            ?.map((dynamic e) =>
                OfficialsDetail.fromJson(e as Map<String, dynamic>))
            .toList(),
  ...
  HomeTeamDetail.fromJson(Map<String, dynamic> json)
      : country = json['country'] as String?,
        ...
        substitutions = (json['substitutions'] as List?)
            ?.map((dynamic e) =>
                Substitutions.fromJson(e as Map<String, dynamic>))
            .toList(),
        startingPlayers = (json['startingPlayers'] as List?)
            ?.map((dynamic e) =>
                StartingPlayers.fromJson(e as Map<String, dynamic>))
            .toList();
...
class Substitutions {
  ...
  Substitutions.fromJson(Map<String, dynamic> json)
      : minute = json['minute'] as String?,
        playerIn = (json['playerIn'] as Map<String, dynamic>?) != null
            ? PlayerIn.fromJson(json['playerIn'] as Map<String, dynamic>)
            : null,
        playerOut = (json['playerOut'] as Map<String, dynamic>?) != null
